...
uf1 = UserFollow.create!(user_id: u7.id, followed_user_id: u6.id)
uf2 = UserFollow.create!(user_id: u2.id, followed_user_id: u5.id)
uf3 = UserFollow.create!(user_id: u9.id, followed_user_id: u3.id)
uf1 = UserFollow.create!(user_id: u9.id, followed_user_id: u2.id)
uf2 = UserFollow.create!(user_id: u10.id, followed_user_id: u1.id)
uf3 = UserFollow.create!(user_id: u11.id, followed_user_id: u8.id)